...
public class DiffractionProjectileRed extends DiffractionProjectile {
    public DiffractionProjectileRed(EntityType type, World world) {
        super(type, world);
    }

    public DiffractionProjectileRed(World world, LivingEntity player, Ability ability) {
        super(SukeProjectiles.DIFFRACTION_RED.get(), world, player, ability);
