...
public class DiffractionProjectile extends AbilityProjectileEntity {

    public DiffractionProjectile(EntityType type, World world) {
        super(type, world);
    }

    public DiffractionProjectile(World world, LivingEntity player, Ability ability) {
        super(SukeProjectiles.DIFFRACTION.get(), world, player, ability);
