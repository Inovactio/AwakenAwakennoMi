...
public class KukuMobs {
    ...
    public static void registerEntityRenderers(FMLClientSetupEvent event) {
        RenderingRegistry.registerEntityRenderingHandler((EntityType)CAKE_GOLEM.get(), new CakeGolemRenderer.Factory());
    }

    @SubscribeEvent
    public static void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
        event.put(CAKE_GOLEM.get(), CakeGolemEntity.createAttributes().build());
    }
}
