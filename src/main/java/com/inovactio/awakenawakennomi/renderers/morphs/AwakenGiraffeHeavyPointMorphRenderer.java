...
public class AwakenGiraffeHeavyPointMorphRenderer<T extends AbstractClientPlayerEntity, M extends MorphModel> extends ZoanMorphRenderer<T, M> {
    public AwakenGiraffeHeavyPointMorphRenderer(EntityRendererManager renderManager, MorphInfo info, boolean hasSmallHands) {
...
//    }
    ...
    public static class Factory<T extends PlayerEntity> implements IRenderFactory<T> {
        ...
        public EntityRenderer<? super T> createRenderFor(EntityRendererManager manager) {
            return new AwakenGiraffeHeavyPointMorphRenderer(manager, this.info, this.hasSmallHands);
        }
    }
}
