...
import com.inovactio.awakenawakennomi.effects.size.GulliversNightmareEffect;
import com.inovactio.awakenawakennomi.effects.size.ShrinkEffect;
...
public class ModEffects {
    ...
    public static final RegistryObject<Effect> GULLIVERS_NIGHTMARE_SHRINK = WyRegistry.registerEffect("Gulliver's Nightmare Shrink", GulliversNightmareEffect::new);
